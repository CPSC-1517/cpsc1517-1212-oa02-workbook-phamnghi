...
namespace WestWindSystem.BLL
{
    ...
    {
        //Step 1: Define a readonly public DbContext field that is initialized using
        ...
        {
            var query = _dbContext.Products.Where(p => p.ProductName.Contains(partialProductName));
            count = query.Count();
