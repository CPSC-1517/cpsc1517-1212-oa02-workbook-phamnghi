...
namespace WestWindWebApp.Pages.Products
{
    ...
    {
        #region Define a CategoryServices field and ProductServices fields and initialize it using constructor injection
        ...
        #region Dafine properties for data the web page needs to access
        ...
        public IActionResult OnPostSearchByCategoryName()
        {
            if (SelectedCategoryID == 0)
            {
